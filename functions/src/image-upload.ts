...
export const resizeThumbnail = functions.storage.object().onFinalize(async (object, context) => {
  ...
  console.log(`Thumbnail generation started: ${contentType} ${fileDir} ${fileName}`);
