...
(function() {
    ...
    Question.prototype.checkAnswer = function(userAnswer, callback) {
        ...
        this.displayScore(callback(this.correctAnswer === userAnswer));
    }
    question.checkAnswer(userAnswer, keepScore);
    ...
    nextQuestion = () => {
        let userAnswer = prompt('Please select the correct answer.');
        ...
        if (userAnswer !== 'exit') {
            ...
            let question = arrayQuestions[randomQuestion];
            question.displayQuestion();
            question.checkAnswer(parseInt(userAnswer), keepScore);
            nextQuestion();
        }
    }
    nextQuestion();
